...
export default function Admin() {
  ...
  const exportPDF = () => {
    ...
    const tableColumn = ["S/N", "Title", "Name", "Profession", "Gender", "Marital Status", "Phone", "Residence", "Skills"];
    const tableRows: any[] = [];
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <h1 className="text-3xl font-bold text-green-800 mb-4 text-center">Registered Attendees</h1>
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto">
          ...
          <button
            onClick={exportPDF}
            className="mb-4 px-4 py-2 bg-green-700 text-white font-bold rounded hover:bg-green-800"
          >
            Export to PDF
          </button>
